...
export const chapters: ChapterRecord[] = [
  ...
  },
  {
    ...
    order: 5,
    title: '规模法则与涌现',
    subtitle: '阶段五：范式重塑 2018 – 2023 | 阶段六：纪元开启 2023 – 2026',
    range: '5:30 - 7:30',
    duration: '2:00',
    ...
    implemented: true,
    pages: [
      { id: '05-act', title: '阶段五：规模法则与涌现', note: '阶段五 · 范式重塑 2018-2023', implemented: true },
      { id: '05-era', title: '阶段六：Attention 纪元与底层重构', note: '阶段六 · 纪元开启 2023-2026', implemented: true },
    ],
    component: Chapter05,
  },
];
