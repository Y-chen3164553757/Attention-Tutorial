...
export const chapters: ChapterRecord[] = [
  ...
  },
  {
    ...
    implemented: true,
    pages: [
      { id: '05-act', title: '阶段五：规模法则与涌现', note: '范式重塑 · 2018 – 2023', implemented: true },
      { id: '05-era', title: '阶段六：Attention 纪元开启', note: '全维度衍生 · 2017 – 2025', implemented: true },
      { id: '05-rivalry', title: '阶段七：全球 AI 双峰对决', note: '大模型生态 · 2023 – 2025', implemented: true },
      { id: '05-deepseek', title: '阶段八：DeepSeek 破壁时刻', note: '底层技术重构 · 2024 – 2025', implemented: true },
      { id: '05-2026', title: '阶段九：2026 激战正酣', note: 'Attention 探索继续 · 2026.1 – 2026.5', implemented: true },
    ],
    component: Chapter05,
  },
];
