...
然而，千亿参数模型的输出仍与人类需求存在明显偏差。经过数年的探索，RLHF（人类反馈强化学习）技术终于在 2022 年初的 InstructGPT 上成熟落地，完成了至关重要的 "对齐"。2022 年底，搭载该技术的 ChatGPT 横空出世，上线仅 5 天用户破百万。`,
  ...
  },
  {
    ...
    timelineCards: [
      ...
      { date: '2026-04-07', dateShort: '4月7日',  company: '智谱', companyEn: 'Zhipu AI', model: 'GLM-5.1', desc: '强化复杂系统工程，SWE-Bench Pro 表现大幅跃升。', faction: 'china', icon: 'zhipu-color.png', color: '#FFD700', tag: '代码工程' },
      { date: '2026-04-09', dateShort: '4月9日',  company: '豆包', companyEn: 'ByteDance', model: 'Doubao Seed 2.0', desc: '字节跳动针对端侧与视频流优化的最新基座。', faction: 'china', icon: 'doubao-color.png', color: '#CC33FF', tag: '端侧视频' },
      ...
      { date: '2026-04-16', dateShort: '4月16日', company: 'Anthropic', companyEn: 'Anthropic', model: 'Claude Opus 4.7', desc: '企业级市场最新旗舰，强化复杂逻辑连贯性。', faction: 'us', icon: 'claude-color.png', color: '#FF6B6B', tag: '最新旗舰' },
      { date: '2026-04-17', dateShort: '4月17日', company: 'xAI', companyEn: 'xAI', model: 'Grok 4.3 Beta', desc: '结合实时数据的最新大参数迭代版本。', faction: 'us', icon: 'grok.png', color: '#8B5CF6', tag: '实时数据' },
      { date: '2026-04-18', dateShort: '4月18日', company: '通义千问', companyEn: 'Alibaba Qwen', model: 'Qwen3.6-Max-Preview', desc: 'Qwen 家族最新一代满血版预览。', faction: 'china', icon: 'qwen-color.png', color: '#FF6B35', tag: '满血预览' },
      ...
      { date: '2026-04-23', dateShort: '4月23日', company: 'DeepSeek', companyEn: 'DeepSeek', model: 'DeepSeek-V4 / V4-Pro', desc: '全球首创代币维度压缩注意力机制，迈入百万上下文普惠时代。', faction: 'china', icon: 'deepseek-color.png', color: '#00BFFF', tag: '技术突破' },
